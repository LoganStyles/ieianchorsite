        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form role="form" action="{{ route('process_management')}}" method="post" id="management_form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="portlet-body form">                                    
                        ...
                        <div id="management_delete_modal" class="modal fade" tabindex="-1">
                            ...
                            <div class="modal-body">
                                ...
                                <form role="form" action="{{ route('delete_ab')}}" method="post" id="management_delete_form" class="form-horizontal">
