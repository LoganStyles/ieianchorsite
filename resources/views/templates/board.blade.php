        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form role="form" action="{{ route('process_board')}}" method="post" id="board_form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="portlet-body form">                                    
                        ...
                        <div id="board_delete_modal" class="modal fade" tabindex="-1">
                            ...
                            <div class="modal-body">
                                ...
                                <form role="form" action="{{ route('delete_ab')}}" method="post" id="board_delete_form" class="form-horizontal">
